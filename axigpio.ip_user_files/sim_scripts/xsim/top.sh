...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_3 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_33 -L xil_defaultlib -L secureip --snapshot  xil_defaultlib. -log elaborate.log
}
...
map_local_libs()
{
  ...
  local_libs=(axi_lite_ipif_v3_0_4 lib_cdc_v1_0_3 interrupt_control_v3_1_5 axi_gpio_v2_0_33)
